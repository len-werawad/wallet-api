...
class PaginationTest {
    ...
    void testPageRequestDefaults() {
        var pageRequest = new com.lbk.socialbanking.common.api.dto.PageRequest(null, null);
    ...
    void testPageRequestWithValues() {
        var pageRequest = new com.lbk.socialbanking.common.api.dto.PageRequest(2, 10);
